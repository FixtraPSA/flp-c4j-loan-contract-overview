sap.ui.define(
  [
    ...
    "baolblacovr/model/grouper",
    "baolblacovr/model/GroupSortState",
  ],
  function (
    BaseController,
    JSONModel,
    ...
    return BaseController.extend("baolblacovr.controller.Master", {
      formatter: formatter,
      ...
      onInit: function () {
        ...
        // 	var aFilters = this.getParamFilters();
        //	sap.m.MessageToast.show(aFilters);
        ...
        if (sQuery) {
          if (isNaN(sQuery)) {
            this._oListFilterState.aSearch = [
              new Filter("BorrowerTxt", FilterOperator.Contains, sQuery),
            ];
          } else {
            this._oListFilterState.aSearch = [
              new Filter("BorrowerID", FilterOperator.EQ, sQuery),
            ];
          }
        } else {
          this._oListFilterState.aSearch = [];
      ...
      onOpenViewSettings: function () {
        if (!this._oViewSettingsDialog) {
          this._oViewSettingsDialog = sap.ui.xmlfragment(
            "baolblacovr.view.ViewSettingsDialog",
            this,
          );
      ...
      onNavBack: function () {
        ...
        if (sPreviousHash !== undefined) {
          ...
          const PartnerID = this._FA2A_getPartnerID();
          if (PartnerID !== undefined) {
            // FA2A FioriAppToApp -> return to Business Partner
            oCrossAppNavigator.toExternal({
              target: {
                semanticObject: "BusinessPartnerOverview",
                action: "Display",
              },
              params: {
                PartnerID: PartnerID,
      ...
      _createViewModel: function () {
        return new JSONModel({
          ...
          sortBy: "Party/BusinessPartnerFormattedName",
          groupBy: "None",
        });
      },
      ...
      _onMasterMatched: function () {
        ...
        const contractID = this._FA2A_getContractID();
        if (contractID) {
          const accountID = contractID.split("-")[2];
          const myFilter = [
        ...
        this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
          function (mParams) {
            ...
            const sObjectId = mParams.firstListitem
              .getBindingContext()
              .getProperty("ID");
      ...
      _applyFilterSearch: function () {
        const aFilters = this._oListFilterState.aSearch.concat(
      ...
      // FA2A FioriAppToApp
      _FA2A_getContractID: function () {
        let contractID, aStartupParameters;
        const sComponentId = sap.ui.core.Component.getOwnerIdFor(
          this.getView(),
        );
        const oMyComponent = sap.ui.component(sComponentId);
        // @ts-ignore
        if (oMyComponent && oMyComponent.getComponentData()) {
          aStartupParameters =
            // @ts-ignore
            oMyComponent.getComponentData().startupParameters;
          if (aStartupParameters) {
            if (
              aStartupParameters.contractID &&
              aStartupParameters.contractID[0]
            ) {
              contractID = aStartupParameters.contractID[0];
            }
            return contractID;
          }
        }
      ...
      // FA2A FioriAppToApp
      _FA2A_getPartnerID: function () {
        let PartnerID, aStartupParameters;
        const sComponentId = sap.ui.core.Component.getOwnerIdFor(
          this.getView(),
        );
        const oMyComponent = sap.ui.component(sComponentId);
        ...
        if (oMyComponent && oMyComponent.getComponentData()) {
          ...
          if (aStartupParameters) {
            if (
              aStartupParameters.PartnerID &&
              aStartupParameters.PartnerID[0]
            ) {
              PartnerID = aStartupParameters.PartnerID[0];
            }
            return PartnerID;
          }
        }
